...
import { login, register, getUserInfo, sendCaptcha } from "@/lib/api/auth";
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    // disabled
                    className="w-full h-12 rounded-2xl bg-muted/50 text-muted-foreground border-0 font-medium flex items-center justify-center gap-3 cursor-not-allowed opacity-60"
                  >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      className="flex-1 h-12 rounded-2xl bg-muted/50 text-muted-foreground hover:bg-muted font-medium cursor-not-allowed opacity-60"
                    >
